...
inline simd::Vec_f_t pos_simd(const Grid& g, int i, int n, int stagger) {
  simd::Vec_f_t result = simd::vec_inc * g.delta[i] + g.pos(i, n, stagger);
  return result;
}
...
#ifdef USE_SIMD
inline simd::Vec_f_t get_x_simd(const simd::Vec_f_t& r) { return log(r); }

inline simd::Vec_f_t get_r_simd(const simd::Vec_f_t& x, const simd::Vec_f_t& y,
                                const simd::Vec_f_t& z) {
  return exp(x);
}

inline simd::Vec_f_t get_th_simd(const simd::Vec_f_t& x, const simd::Vec_f_t& y,
                                 const simd::Vec_f_t& z) {
  return y;
}

inline simd::Vec_f_t get_gamma_d11_simd(const simd::Vec_f_t& x,
                                        const simd::Vec_f_t& y,
                                        const simd::Vec_f_t& z) {
  auto r = get_r_simd(x, y, z);
  return r * r;
}

inline simd::Vec_f_t get_gamma_d22_simd(const simd::Vec_f_t& x,
                                        const simd::Vec_f_t& y,
                                        const simd::Vec_f_t& z) {
  auto r = get_r_simd(x, y, z);
  return r * r;
...
inline simd::Vec_f_t get_gamma_d33_simd(const simd::Vec_f_t& x,
                                        const simd::Vec_f_t& y,
                                        const simd::Vec_f_t& z) {
  auto r = get_r_simd(x, y, z);
...
inline simd::Vec_f_t get_gamma_simd(const simd::Vec_f_t& x,
                                    const simd::Vec_f_t& y,
                                    const simd::Vec_f_t& z) {
...
inline simd::Vec_f_t get_sqrt_gamma_simd(const simd::Vec_f_t& x,
                                         const simd::Vec_f_t& y,
                                         const simd::Vec_f_t& z) {
...
HD_INLINE Scalar get_x(Scalar r) { return log(r); }

HD_INLINE Scalar get_r(Scalar x, Scalar y, Scalar z) { return exp(x); }

HD_INLINE Scalar get_th(Scalar x, Scalar y, Scalar z) { return y; }
